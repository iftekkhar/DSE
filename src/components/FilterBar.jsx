...
export default function FilterBar({
  ...
  return (
    <div className="card-elevation p-3 mb-5 space-y-2.5">
      {/* Top Row: Strategy Tabs */}
      <div className="flex items-center gap-1.5 overflow-x-auto pb-1.5 border-b border-slate-100 no-scrollbar">
        {tabs.map((tab) => {
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 text-xs pt-0.5">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={onExportCSV}
            className="flex items-center gap-1.5 px-2.5 py-1.5 bg-slate-50 hover:bg-slate-100 text-slate-700 font-semibold rounded-xl border border-slate-200 transition-colors shadow-2xs cursor-pointer"
